...
// FIX 1: Changed import name from IntelligenceAggregationService to UnifiedIntelligence
...
        // FIX 2: Changed usage from IntelligenceAggregationService to UnifiedIntelligence
        UnifiedIntelligence.aggregateIntelligence(brandId),
        // FIX 3: Changed usage from IntelligenceAggregationService to UnifiedIntelligence
        UnifiedIntelligence.getIntelligenceSummary(brandId),
      ]);
