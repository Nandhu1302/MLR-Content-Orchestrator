...
export const SPECIALIST_PROFILES = {
  oncologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with survival benefit, follow with response data, detail safety, conclude with patient selection",
    },
  },
  ...
  cardiologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with cardiovascular outcomes, balance with safety, discuss patient selection and monitoring",
    },
  },
  ...
  pulmonologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with lung function data, discuss disease progression, detail safety and patient monitoring",
    },
  },
  ...
  endocrinologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with glycemic outcomes, cardiovascular benefits, safety profile, patient suitability",
    },
  },
  ...
  dermatologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with efficacy scores, discuss patient-reported outcomes, detail safety for chronic use",
    },
  },
  ...
  neurologist: {
    contentCharacteristics: {
      ...
      structure:
        "Lead with stroke prevention data, balance bleeding risk, discuss patient selection and monitoring",
    },
  },
  ...
  "ent-specialist": {
    contentCharacteristics: {
      ...
      structure:
        "Lead with symptom control, discuss quality of life, detail safety for chronic management",
    },
  },
};

// Base audience profiles (non-specialist audience types)
export const BASE_AUDIENCE_PROFILES = {
  "physician-specialist": {
    ...
    callToActionStyle:
      'Professional invitation (e.g., "Review full prescribing information", "Discuss with your representative")',
  },
  ...
  "physician-primary-care": {
    ...
    callToActionStyle:
      'Action-oriented (e.g., "Access patient starter kit", "Download treatment guide")',
  },
  ...
  pharmacist: {
    ...
    description:
      "Pharmacists focused on medication management, safety, and patient counseling",
    defaultTone: "professional",
    defaultDepth: "detailed",
    defaultTerminology: "technical",
    contentCharacteristics: {
    ...
    callToActionStyle:
      'Resource-focused (e.g., "Download patient counseling guide", "Access dosing calculator")',
  },
  ...
  "nurse-rn": {
    ...
    description:
      "RNs focused on patient care coordination, administration, and monitoring",
    defaultTone: "professional",
    defaultDepth: "moderate",
    defaultTerminology: "professional",
    contentCharacteristics: {
    ...
    callToActionStyle:
      'Care-enabling (e.g., "Access patient education materials", "Download administration checklist")',
  },
  ...
  "nurse-np-pa": {
    ...
    description:
      "NPs/PAs with prescribing authority who need clinical guidance and practical application",
    defaultTone: "professional",
    defaultDepth: "moderate",
    defaultTerminology: "professional",
    contentCharacteristics: {
    ...
    callToActionStyle:
      'Clinical-practical (e.g., "Review prescribing guide", "Access patient selection tool")',
  },
  ...
  patient: {
    ...
    displayName: "Patient",
    description:
      "Patients who need clear, accessible information about their condition and treatment",
    ...
    callToActionStyle:
      'Supportive-empowering (e.g., "Talk to your doctor", "Get support", "Learn more")',
  },
  ...
  "caregiver-family": {
    ...
    description:
      "Family members caring for loved ones who need practical support and guidance",
    defaultTone: "empathetic",
    defaultDepth: "moderate",
    ...
    callToActionStyle:
      'Supportive (e.g., "Get caregiver resources", "Join support community", "Download care guide")',
  },
  ...
  "caregiver-professional": {
    ...
    description:
      "Professional caregivers (CNAs, home health aides) who need clinical guidance for patient support",
    defaultTone: "professional",
    defaultDepth: "moderate",
    defaultTerminology: "professional",
    contentCharacteristics: {
    ...
    callToActionStyle:
      'Professional (e.g., "Access care protocols", "Download monitoring checklist")',
  },
};

/**
 * Get specialist profile with indication-specific overrides
 * (Currently merges base specialist profile with specialist overrides)
 */
export const getSpecialistProfile = (specialistType, indication) => {
  // Base: physician-specialist
  ...
  return {
    ...
    // Indication parameter reserved for future conditional overrides
