...
export const PIEvidencePreviewModal = ({
  ...
  const selectedSections = Array.isArray(alignment.selectedSections) 
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/30 p-4 rounded-md">
              <p className="text-xs text-muted-foreground">
                <strong>Note:</strong> This preview shows the PI sections that will inform your
                content generation. The actual content will be strategically crafted based on your
                theme, objective, and audience while maintaining clinical accuracy from these
                sections.
              </p>
            </div>
          </div>
